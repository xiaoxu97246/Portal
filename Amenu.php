<!-- Main menu (tabs) -->
     <div id="tabs" class="noprint">
            ...
            <ul class="box">
                <li><a href="Aindex.php">Home<span class="tab-l"></span><span class="tab-r"></span></a></li>
                <li><a href="User.php">User<span class="tab-l"></span><span class="tab-r"></span></a></li>
                <li><a href="ManageJobSeeker.php">Manage JobSeeker<span class="tab-l"></span><span class="tab-r"></span></a></li>
                <li><a href="ManageEmployer.php">Manage Employer<span class="tab-l"></span><span class="tab-r"></span></a></li>
                <li><a href="ANews.php">News<span class="tab-l"></span><span class="tab-r"></span></a></li>
