<!-- Main menu (tabs) -->
     <div id="tabs" class="noprint">
            ...
            <ul class="box">
                <li><a href="Eindex.php">Home<span class="tab-l"></span><span class="tab-r"></span></a></li>
                <li><a href="EProfile.php">Profile<span class="tab-l"></span><span class="tab-r"></span></a></li>
