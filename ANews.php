    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <div class="article">
                ...
                <table>
                  <tr>
                    <td height="27" bgcolor="#A0B9F3"><span class="style4 style10">Manage News</span></td>
                  </tr>
                  <tr>
                    <td><table width="100%" border="1" bordercolor="#1CB5F1" >
                      <tr>
                        <th height="32" bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Id</strong></div></th>
                        <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5">News Description</div></th>
                        <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Date of Posted</strong></div></th>
                      ...
                      <tr>
                        ...
                        <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $News;?></strong></div></td>
                         <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $Date;?></strong></div></td>
                          <td class="style3"><div align="left" class="style9 style5"><strong><a href="DeleteNews.php?NewsId=<?php echo $Id;?>">Delete</a></strong></div></td>
                      </tr>
                      <?php
}
